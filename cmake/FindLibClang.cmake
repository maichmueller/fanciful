...
if(${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
    set(_libclang_name "libclang.so")
elseif (${CMAKE_SYSTEM_NAME} STREQUAL "Darwin")
    set(_libclang_name "libclang.dylib")
elseif (${CMAKE_SYSTEM_NAME} STREQUAL "Windows")
    set(_libclang_name "libclang.dll")
else ()
    message(FATAL_ERROR "LIBCLANG search not configured on platform ${CMAKE_SYSTEM_NAME}." )
endif()

message("Conda prefix: $ENV{CONDA_PREFIX}")
find_library(LibClang_LIBRARY ${_libclang_name} PATH_SUFFIXES $ENV{CONDA_PREFIX}/lib x86_64-linux-gnu)
