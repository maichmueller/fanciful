...
function(cppyy_add_bindings pkg pkg_version author author_email)
    ...
    if(${CONDA_ACTIVE})
        set(CLANGDEV_INCLUDE
                "${CONDA_PREFIX}/lib/clang/${CLANG_VERSION_STRING}/include"
#                "${CONDA_ACTIVE_ENV_PREFIX}/lib/clang/${CLANG_VERSION_STRING}/include"
        )
    ...
    #
    find_program(CPPY_GENERATOR_CMD cppyy-generator HINTS $ENV{CONDA_PREFIX} ${CONDA_ACTIVE_ENV}/bin)
    set(Cppyygen_EXECUTABLE ${CPPY_GENERATOR_CMD})
